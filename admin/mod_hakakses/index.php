...
<a href="?modul=mod_hakakses&act=add" class="btn btn-primary mb-2 sticky-top">Tambah Data</a>
    <table class="table table-striped table-primary table-bordered border-info">
        <tr>
            ...
            ?>
                <tr>
                    <td value="<?= $row['idmenu'];?>"><?= $row['username'];?></td>
                    <td value="<?= $row['iduser'];?>"><?= $row['nmmenu'];?></td>
                </tr>
            <?php
            endforeach;
            ?>
         ...
         <div class="container-lg mt-1 ">
                    ...
                    <label for="" class="col-sm-2 col-form-label">Username</label>
                        <div class="col-sm-4">
                            <select name="iduser" id="" class="form-select">
                                ...
                                ?>
                                <option value="<?= $r['iduser'];?>"><?= $r['username'];?></option>
                                <?php
                                };
                                ?>
                            </select>
                ...
                <table class="table table-striped table-primary table-bordered border-info">
                    <tr>
                       ...
                       ?>
                           <tr>
                               <td><input class="form-check-input" type="checkbox" name="idmenu[]" id="ckmenu" value="<?= $r['idmenu'];?>"></td>
