        ...
        <table class="table table-bordered "> 
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="?modul=mod_request&act=edit&id=<?= $row['id_request']; ?>" class="btn btn-xs btn-primary"> <i class="bi bi-pencil-square" > </i> detail </a>
                    </div>
            </td>
            </tr>
            <?php
  ...
  <?php
        ...
        ?>
            <div class="row">
                ...
                <form action="mod_request/requestctrl.php?modul=mod_request&act=update" method="post">
                <div class="row pt-2">
                <div class="col-md-2"> 
            </div>  
            <div class="col-md-5"> 
